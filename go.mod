...
require (
	...
	github.com/altinity/clickhouse-operator v0.0.0-20220513145830-11d3b3f4e99d
...
replace github.com/altinity/clickhouse-operator => ../clickhouse-operator
